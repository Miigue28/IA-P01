...
class ComportamientoJugador : public Comportamiento
{
  ...
  public:
    ...
    bool alreadyExplored(const vector<vector<unsigned char>> & map, const State & st, const Vision & vision);
    ...
    Action goToObjective(const vector<unsigned char> & terreno, const vector<unsigned char> & agentes, const vector<vector<unsigned int>> & prio);
